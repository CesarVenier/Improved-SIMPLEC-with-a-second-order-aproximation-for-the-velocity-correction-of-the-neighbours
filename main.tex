...
In contrast to the previuos cases, this problem aims to analyze the performance of the method in a context with variable viscosity given by the application of a turbulence model.
...
\CIP{Aquí ponemos la figura? vale la pena?}
