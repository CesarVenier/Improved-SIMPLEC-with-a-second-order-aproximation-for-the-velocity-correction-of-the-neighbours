...
\begin{equation}
    e^k_{\phi,M} = \alpha^k_{\phi} \; \text{exp} \left(i \; \dfrac{x_M \; \theta}{\boldsymbol{\delta} x}\right)
    \label{eq:error}
\end{equation}
...
\alpha_p 
\end{bmatrix}^{k}
\; \text{exp}\left[ i \; \theta \; \frac{x_M}{\boldsymbol{\delta} x}\right]
\label{eq:fou1}
\end{equation}
